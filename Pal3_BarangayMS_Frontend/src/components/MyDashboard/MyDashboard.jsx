...
class MyDashboard extends Component {
  ...
  toggleDashboardDetails = () => {
    this.setState((prev) => ({
      showDashboardDetails: !prev.showDashboardDetails
    }));
  };
  ...
  getDashboardDetails = () => {
    ...
    const { showDashboardDetails } = this.state;
      ...
      <div className='cards_ctr'>
        <div className='cards_ctr_hdr'>
          <div style={{ marginBottom: '15px' }}>
            <button
              ...
              onClick={this.toggleDashboardDetails}
            >
              <i
                className={`bi ${
        ...
        {showDashboardDetails && (
          <div className='grid_ctr'>
            <div>
              <DashboardAnncCard
                header={"Today's Announcement"}
                data={DashboardStore.data.announcementList}
              />
